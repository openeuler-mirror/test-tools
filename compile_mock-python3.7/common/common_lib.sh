...
require_rpms="distribution-gpg-keys-1.35-1.fc31 mock-1.4.20-1.fc31 mock-core-configs-31.6-1.fc31"
require_rpms_PATH="../common/rpms"
test -d $require_rpms_PATH || mkdir $require_rpms_PATH
wget https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/31/Everything/aarch64/os/Packages/d/distribution-gpg-keys-1.35-1.fc31.noarch.rpm -O "$require_rpms_PATH"/distribution-gpg-keys-1.35-1.fc31.noarch.rpm
wget https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/31/Everything/aarch64/os/Packages/m/mock-1.4.20-1.fc31.noarch.rpm -O "$require_rpms_PATH"/mock-1.4.20-1.fc31.noarch.rpm
wget https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/31/Everything/aarch64/os/Packages/m/mock-core-configs-31.6-1.fc31.noarch.rpm -O "$require_rpms_PATH"/mock-core-configs-31.6-1.fc31.noarch.rpm
