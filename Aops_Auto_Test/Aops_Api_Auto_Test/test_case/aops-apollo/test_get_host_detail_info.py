...
data_file = os.path.join(conf.get_data_path(), "aops-apollo", "get_host_detail_info.yaml")
log = my_log()


class TestGetHostDetailInfo:
    ...
    def test_get_host_detail_info(self, test_data):
        ...
        if res["body"]["code"] == '200':
            assert_res.assert_data(res["body"]["data"]["result"], test_data["validate"]["data"])
