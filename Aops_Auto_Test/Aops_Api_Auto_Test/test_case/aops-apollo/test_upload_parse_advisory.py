...
data_file = os.path.join(conf.get_data_path(), "aops-apollo", "upload_parse_advisory.yaml")
log = my_log()


class TestUploadParseAdvisory:
    ...
    def test_upload_parse_advisory(self, test_data):
